 ...
 * @var constants
 */
define("API_DEPLOYMENT_URL", 'http://deploy.jump.snails.email');
...
define("API_DEPLOYMENT_JUMPAPI_HOSTNAMES", 'https://raw.githubusercontent.com/Chronolabs-Cooperative/Jump-API-PHP/master/services.txt');

// define("API_DEPLOYMENT_CALLING", true);
